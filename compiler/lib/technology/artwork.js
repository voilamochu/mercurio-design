...
function renderArtworkWindow() {
  ...
  return [
    ...
    `  <text x="${w.x + w.width / 2}" y="${w.y + w.height / 2}" font-family="sans-serif" font-size="22" fill="#6b7280" text-anchor="middle" dominant-baseline="middle">artwork: ${ARTWORK_WINDOW_PLACEHOLDER()}</text>`,
  ].join('\n');
}
